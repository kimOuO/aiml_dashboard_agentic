...
const TaskState = ({state}) => {
  ...
  return (
    <div className={`inline-flex items-center ${bgColor} ${textColor} text-sm font-medium px-2.5 py-0.5 rounded `}>
      <svg className={`w-2.5 h-2.5 mr-1.5 ${dotColor}`} fill="currentColor" viewBox="0 0 8 8">
