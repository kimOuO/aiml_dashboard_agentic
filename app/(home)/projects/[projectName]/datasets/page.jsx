...
const DatasetsPage = ({ 
  ...
  filteredDatasets, isLoading, currentPage, totalPage, handlePageChange, handleBackClick}) => {
  return (
...
const Page = () => {
  ...
  const { dataset, isLoading } = useFetchDatasets(projectName, activeTab, searchQuery, currentPage);
